...
JPsiToMuMuTable = cms.EDProducer(
   'SimpleCompositeCandidateFlatTableProducer',
    ...
    variables=cms.PSet(
        MuMu_sv_prob = ufloat('sv_prob'),
        MuMu_fitted_mass = ufloat('fitted_mass'),
        MuMu_fitted_pt  = ufloat('fitted_pt'),
        MuMu_fitted_eta = ufloat('fitted_eta'),
        MuMu_fitted_phi = ufloat('fitted_phi'),
        MuMu_fitted_vtxX = ufloat('fitted_vtxX'),
        MuMu_fitted_vtxY = ufloat('fitted_vtxY'),
        MuMu_fitted_vtxZ = ufloat('fitted_vtxZ'),
        MuMu_fitted_vtxXE = ufloat('fitted_vtxEx'),
        MuMu_fitted_vtxYE = ufloat('fitted_vtxEy'),
        MuMu_fitted_vtxZE = ufloat('fitted_vtxEz'),
        MuMu_prefit_mu1_pt  = ufloat('mu1_pt'),
        MuMu_prefit_mu1_eta = ufloat('mu1_eta'),
        MuMu_prefit_mu1_phi = ufloat('mu1_phi'),
        MuMu_prefit_mu2_pt  = ufloat('mu2_pt'),
        MuMu_prefit_mu2_eta = ufloat('mu2_eta'),
        MuMu_prefit_mu2_phi = ufloat('mu2_phi'),
        MuMu_mu1_dr = ufloat('mu1_dr'),
        MuMu_mu2_dr = ufloat('mu2_dr'),
        MuMu_DCA = ufloat('DCA'),
        MuMu_LxySign = ufloat('LxySign'),
        MuMu_cosAlpha = ufloat('cosAlpha'),
        # MuMu_mu1_dzsign  = ufloat('mu1_dzsign'),
        # MuMu_mu2_dzsign  = ufloat('mu2_dzsign'),
        # MuMu_mu1_dxysign = ufloat('mu1_dxysign'),
        # MuMu_mu2_dxysign = ufloat('mu2_dxysign'),

        # 2017 and 2018 interesting triggers mu1 fired
        # MuMu_mu1_fired_Dimuon25_Jpsi                   = uint('mu1_fired_Dimuon25_Jpsi'),
        # MuMu_mu1_fired_Dimuon18_PsiPrime               = uint('mu1_fired_Dimuon18_PsiPrime'),
        # MuMu_mu1_fired_DoubleMu4_JpsiTrk_Displaced     = uint('mu1_fired_DoubleMu4_JpsiTrk_Displaced'),
        # MuMu_mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced = uint('mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced'),
        # MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced  = uint('mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced'),

        # 2018 Charmonium triggers mu1 fired
        # MuMu_mu1_fired_Dimuon0_Jpsi3p5_Muon2                  = uint( 'mu1_fired_Dimuon0_Jpsi3p5_Muon2'),
        # MuMu_mu1_fired_Dimuon0_Jpsi_L1_4R_0er1p5R             = uint( 'mu1_fired_Dimuon0_Jpsi_L1_4R_0er1p5R'),
        # MuMu_mu1_fired_Dimuon0_Jpsi_L1_NoOS                   = uint( 'mu1_fired_Dimuon0_Jpsi_L1_NoOS'),
        # MuMu_mu1_fired_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R'),
        # MuMu_mu1_fired_Dimuon0_Jpsi_NoVertexing_NoOS          = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing_NoOS'),
        # MuMu_mu1_fired_Dimuon0_Jpsi_NoVertexing               = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing'),
        # MuMu_mu1_fired_Dimuon0_Jpsi                           = uint( 'mu1_fired_Dimuon0_Jpsi'),
        # MuMu_mu1_fired_Dimuon0_LowMass_L1_0er1p5R             = uint( 'mu1_fired_Dimuon0_LowMass_L1_0er1p5R'),
        # MuMu_mu1_fired_Dimuon0_LowMass_L1_0er1p5              = uint( 'mu1_fired_Dimuon0_LowMass_L1_0er1p5'),
        # MuMu_mu1_fired_Dimuon0_LowMass_L1_4R                  = uint( 'mu1_fired_Dimuon0_LowMass_L1_4R' ),
        # MuMu_mu1_fired_Dimuon0_LowMass_L1_4                   = uint( 'mu1_fired_Dimuon0_LowMass_L1_4' ),
        # MuMu_mu1_fired_Dimuon0_LowMass                        = uint( 'mu1_fired_Dimuon0_LowMass' ),
        # MuMu_mu1_fired_Dimuon10_PsiPrime_Barrel_Seagulls      = uint( 'mu1_fired_Dimuon10_PsiPrime_Barrel_Seagulls' ),
        # MuMu_mu1_fired_Dimuon18_PsiPrime_noCorrL1             = uint( 'mu1_fired_Dimuon18_PsiPrime_noCorrL1' ),
        # MuMu_mu1_fired_Dimuon18_PsiPrime                      = uint( 'mu1_fired_Dimuon18_PsiPrime' ),
        # MuMu_mu1_fired_Dimuon20_Jpsi_Barrel_Seagulls          = uint( 'mu1_fired_Dimuon20_Jpsi_Barrel_Seagulls' ),
        # MuMu_mu1_fired_Dimuon25_Jpsi_noCorrL1                 = uint( 'mu1_fired_Dimuon25_Jpsi_noCorrL1' ),
        # MuMu_mu1_fired_Dimuon25_Jpsi                          = uint( 'mu1_fired_Dimuon25_Jpsi' ),
        # MuMu_mu1_fired_DoubleMu2_Jpsi_DoubleTkMu0_Phi         = uint( 'mu1_fired_DoubleMu2_Jpsi_DoubleTkMu0_Phi' ),
        # MuMu_mu1_fired_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05      = uint( 'mu1_fired_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05' ),
        # MuMu_mu1_fired_DoubleMu4_3_Bs                         = uint( 'mu1_fired_DoubleMu4_3_Bs' ),
        # MuMu_mu1_fired_DoubleMu4_3_Jpsi                       = uint( 'mu1_fired_DoubleMu4_3_Jpsi' ),
        # MuMu_mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced         = uint( 'mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced' ),
        # MuMu_mu1_fired_DoubleMu4_JpsiTrk_Displaced            = uint( 'mu1_fired_DoubleMu4_JpsiTrk_Displaced' ),
        # MuMu_mu1_fired_DoubleMu4_Jpsi_NoVertexing             = uint( 'mu1_fired_DoubleMu4_Jpsi_NoVertexing' ),
        # MuMu_mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced        = uint( 'mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced' ),
        # MuMu_mu1_fired_Mu30_TkMu0_Psi      = uint( 'mu1_fired_Mu30_TkMu0_Psi' ),
        # MuMu_mu1_fired_Mu7p5_L2Mu2_Jpsi    = uint( 'mu1_fired_Mu7p5_L2Mu2_Jpsi' ),
        # MuMu_mu1_fired_Mu7p5_Track2_Jpsi   = uint( 'mu1_fired_Mu7p5_Track2_Jpsi' ),
        # MuMu_mu1_fired_Mu7p5_Track3p5_Jpsi = uint( 'mu1_fired_Mu7p5_Track3p5_Jpsi' ),
        # MuMu_mu1_fired_Mu7p5_Track7_Jpsi   = uint( 'mu1_fired_Mu7p5_Track7_Jpsi' ),

        # BPark triggers mu1 fired
        MuMu_mu1_fired_Mu7_IP4      = uint( 'mu1_fired_Mu7_IP4' ),
        MuMu_mu1_fired_Mu8_IP6      = uint( 'mu1_fired_Mu8_IP6' ),
        MuMu_mu1_fired_Mu8_IP5      = uint( 'mu1_fired_Mu8_IP5' ),
        MuMu_mu1_fired_Mu8_IP3      = uint( 'mu1_fired_Mu8_IP3' ),
        MuMu_mu1_fired_Mu8p5_IP3p5  = uint( 'mu1_fired_Mu8p5_IP3p5' ),
        MuMu_mu1_fired_Mu9_IP6      = uint( 'mu1_fired_Mu9_IP6' ),
        MuMu_mu1_fired_Mu9_IP5      = uint( 'mu1_fired_Mu9_IP5' ),
        MuMu_mu1_fired_Mu9_IP4      = uint( 'mu1_fired_Mu9_IP4' ),
        MuMu_mu1_fired_Mu10p5_IP3p5 = uint( 'mu1_fired_Mu10p5_IP3p5' ),
        MuMu_mu1_fired_Mu12_IP6     = uint( 'mu1_fired_Mu12_IP6' ),

        # 2017 and 2018 interesting triggers mu2 fired
        # MuMu_mu2_fired_Dimuon25_Jpsi                   = uint('mu2_fired_Dimuon25_Jpsi'),
        # MuMu_mu2_fired_Dimuon18_PsiPrime               = uint('mu2_fired_Dimuon18_PsiPrime'),
        # MuMu_mu2_fired_DoubleMu4_JpsiTrk_Displaced     = uint('mu2_fired_DoubleMu4_JpsiTrk_Displaced'),
        # MuMu_mu2_fired_DoubleMu4_PsiPrimeTrk_Displaced = uint('mu2_fired_DoubleMu4_PsiPrimeTrk_Displaced'),
        # MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced  = uint('mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced'),

        # 2018 Charmonium triggers mu2 fired
        # MuMu_mu2_fired_Dimuon0_Jpsi3p5_Muon2                  = uint( 'mu1_fired_Dimuon0_Jpsi3p5_Muon2' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi_L1_4R_0er1p5R             = uint( 'mu1_fired_Dimuon0_Jpsi_L1_4R_0er1p5R' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi_L1_NoOS                   = uint( 'mu1_fired_Dimuon0_Jpsi_L1_NoOS' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing_L1_4R_0er1p5R' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi_NoVertexing_NoOS          = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing_NoOS' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi_NoVertexing               = uint( 'mu1_fired_Dimuon0_Jpsi_NoVertexing' ),
        # MuMu_mu2_fired_Dimuon0_Jpsi                           = uint( 'mu1_fired_Dimuon0_Jpsi' ),
        # MuMu_mu2_fired_Dimuon0_LowMass_L1_0er1p5R             = uint( 'mu1_fired_Dimuon0_LowMass_L1_0er1p5R' ),
        # MuMu_mu2_fired_Dimuon0_LowMass_L1_0er1p5              = uint( 'mu1_fired_Dimuon0_LowMass_L1_0er1p5' ),
        # MuMu_mu2_fired_Dimuon0_LowMass_L1_4R                  = uint( 'mu1_fired_Dimuon0_LowMass_L1_4R' ),
        # MuMu_mu2_fired_Dimuon0_LowMass_L1_4                   = uint( 'mu1_fired_Dimuon0_LowMass_L1_4' ),
        # MuMu_mu2_fired_Dimuon0_LowMass                        = uint( 'mu1_fired_Dimuon0_LowMass' ),
        # MuMu_mu2_fired_Dimuon10_PsiPrime_Barrel_Seagulls      = uint( 'mu1_fired_Dimuon10_PsiPrime_Barrel_Seagulls' ),
        # MuMu_mu2_fired_Dimuon18_PsiPrime_noCorrL1             = uint( 'mu1_fired_Dimuon18_PsiPrime_noCorrL1' ),
        # MuMu_mu2_fired_Dimuon18_PsiPrime                      = uint( 'mu1_fired_Dimuon18_PsiPrime' ),
        # MuMu_mu2_fired_Dimuon20_Jpsi_Barrel_Seagulls          = uint( 'mu1_fired_Dimuon20_Jpsi_Barrel_Seagulls' ),
        # MuMu_mu2_fired_Dimuon25_Jpsi_noCorrL1                 = uint( 'mu1_fired_Dimuon25_Jpsi_noCorrL1' ),
        # MuMu_mu2_fired_Dimuon25_Jpsi                          = uint( 'mu1_fired_Dimuon25_Jpsi' ),
        # MuMu_mu2_fired_DoubleMu2_Jpsi_DoubleTkMu0_Phi         = uint( 'mu1_fired_DoubleMu2_Jpsi_DoubleTkMu0_Phi' ),
        # MuMu_mu2_fired_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05      = uint( 'mu1_fired_DoubleMu2_Jpsi_DoubleTrk1_Phi1p05' ),
        # MuMu_mu2_fired_DoubleMu4_3_Bs                         = uint( 'mu1_fired_DoubleMu4_3_Bs' ),
        # MuMu_mu2_fired_DoubleMu4_3_Jpsi                       = uint( 'mu1_fired_DoubleMu4_3_Jpsi' ),
        # MuMu_mu2_fired_DoubleMu4_JpsiTrkTrk_Displaced         = uint( 'mu1_fired_DoubleMu4_JpsiTrkTrk_Displaced' ),
        # MuMu_mu2_fired_DoubleMu4_JpsiTrk_Displaced            = uint( 'mu1_fired_DoubleMu4_JpsiTrk_Displaced' ),
        # MuMu_mu2_fired_DoubleMu4_Jpsi_NoVertexing             = uint( 'mu1_fired_DoubleMu4_Jpsi_NoVertexing' ),
        # MuMu_mu2_fired_DoubleMu4_PsiPrimeTrk_Displaced        = uint( 'mu1_fired_DoubleMu4_PsiPrimeTrk_Displaced' ),
        # MuMu_mu2_fired_Mu30_TkMu0_Psi      = uint( 'mu1_fired_Mu30_TkMu0_Psi' ),
        # MuMu_mu2_fired_Mu7p5_L2Mu2_Jpsi    = uint( 'mu1_fired_Mu7p5_L2Mu2_Jpsi' ),
        # MuMu_mu2_fired_Mu7p5_Track2_Jpsi   = uint( 'mu1_fired_Mu7p5_Track2_Jpsi' ),
        # Mumu_mu2_fired_Mu7p5_Track3p5_Jpsi = uint( 'mu1_fired_Mu7p5_Track3p5_Jpsi' ),
        # MuMu_mu2_fired_Mu7p5_Track7_Jpsi   = uint( 'mu1_fired_Mu7p5_Track7_Jpsi' ),

        # BPark triggers mu2 fired
        MuMu_mu2_fired_Mu7_IP4      = uint( 'mu2_fired_Mu7_IP4' ),
        MuMu_mu2_fired_Mu8_IP6      = uint( 'mu2_fired_Mu8_IP6' ),
        MuMu_mu2_fired_Mu8_IP5      = uint( 'mu2_fired_Mu8_IP5' ),
        MuMu_mu2_fired_Mu8_IP3      = uint( 'mu2_fired_Mu8_IP3' ),
        MuMu_mu2_fired_Mu8p5_IP3p5  = uint( 'mu2_fired_Mu8p5_IP3p5' ),
        MuMu_mu2_fired_Mu9_IP6      = uint( 'mu2_fired_Mu9_IP6' ),
        MuMu_mu2_fired_Mu9_IP5      = uint( 'mu2_fired_Mu9_IP5' ),
        MuMu_mu2_fired_Mu9_IP4      = uint( 'mu2_fired_Mu9_IP4' ),
        MuMu_mu2_fired_Mu10p5_IP3p5 = uint( 'mu2_fired_Mu10p5_IP3p5' ),
        MuMu_mu2_fired_Mu12_IP6     = uint( 'mu2_fired_Mu12_IP6' ),
    )
)
